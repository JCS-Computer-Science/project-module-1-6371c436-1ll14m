export function makeGame(p, setScene, currentMode) {
    class game {
        constructor(easyRules) {
            this.easy = easyRules;
        }
    }
    class buttonGame extends game {
        constructor(easyRules, mediumRules) {
            super(easyRules);
            ...
            setup(x, y, m, t) {
                ...
                _bar.id = "game_bar";
                _bar.className = "borderStyle";
                _bar.style.height = `${t-m}px`;
                _bar.style.width = `${1920-m*2}px`;
                _bar.style.top = `${m}px`;
                _bar.style.left = `${m}px`;
                this._bar = _bar;
            ...
            draw() {
                ...
                if (this.timer > 0) {
                    ...
                    if (currentMode() == "1") {
                        ...
                        this._bar.innerHTML = `${this.easyRules[num]}`
                    } else if (currentMode() == "2") {
                        ...
                        this._bar.innerHTML = `${this.mediumRules[num]}`
                    } else if (currentMode() == "3") {
                        ...
                        this._bar.innerHTML = `${this.hardRules[num]}`
                    }
                } else {
                    this.endframe++;
    ...
    let finalGame = new buttonGame(["red", "blue", "green"], ["red", "blue", "green", "purple"]);
    return {
        finalGame
    },
}
